...
#Trimming
cat sample_names.tmp|parallel --eta -j 10 --load 80% --noswap 'bbduk.sh -Xmx20g in1={}/{}_R1.fastq.gz in2={}/{}_R2.fastq.gz out1={}/Trimmed_{}_R1.fq out2={}/Trimmed_{}_R2.fq ref=/media/data_storage/Hong/index_adapter/iSEQ_adapter_index0.fa ktrim=r k=23 mink=11 hdist=1 tpe tbo qtrim=rl minlength=100 minavgquality=20 &>{}/{}_Trimming.log;'
